...
import 'privacynsecurity_model.dart';
export 'privacynsecurity_model.dart';

class PrivacynsecurityWidget extends StatefulWidget {
  const PrivacynsecurityWidget({super.key});

  @override
  State<PrivacynsecurityWidget> createState() => _PrivacynsecurityWidgetState();
}

class _PrivacynsecurityWidgetState extends State<PrivacynsecurityWidget> {
  late PrivacynsecurityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrivacynsecurityModel());
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: Padding(
                                            ...
                                            child: const ErrorWidgetWidget(
                                              errorString:
                                                  'Not allowed from google sign in.',
                                            ),
                                          ),
                                        ),
                                      );
                                    ...
                                    child: Icon(
                                      ...
                                      color: valueOrDefault<Color>(
                                        FFAppState().isGoogleLogin
                                            ...
                                            : FlutterFlowTheme.of(context)
                                                .midyellow,
                                        FlutterFlowTheme.of(context).lighticon,
                                      ),
                                      size: 24.0,
                                    ),
                                  ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(0.0),
                                    child: Image.asset(
                                      'assets/images/changepass_icon.png',
                                      width: 36.0,
                                      height: 36.0,
                                      fit: BoxFit.cover,
                                    ),
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 4.0, 0.0, 0.0),
                                            child: Text(
                                              'If you notice any suspicious activity, logout of Astraline across all devices.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
