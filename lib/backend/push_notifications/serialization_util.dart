...
T? getParameter<T>(Map<String, dynamic> data, String paramName) {
  try {
    ...
    switch (T) {
      ...
      case StatesRow:
        return StatesRow(json.decode(param) as Map<String, dynamic>) as T;
      case CountryRow:
        return CountryRow(json.decode(param) as Map<String, dynamic>) as T;
      case GeoDataRow:
        return GeoDataRow(json.decode(param) as Map<String, dynamic>) as T;
    }
    if (param is String) {
